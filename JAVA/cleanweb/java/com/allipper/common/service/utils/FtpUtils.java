...
/*	public static void main(String[] args) {
		FtpUtils ft = null;
		try {
			ft = new FtpUtils("10.1.104.27", 21, "bireport","12345678");
			ft.connectFTPServer();
//			ft.changeDirectory("/bireport/");
//			ft.createFold("test");
			
//			String filename = "aa.txt";
//			InputStream input = ft.downloadFile(filename);
//			InputStream input = new FileInputStream("D:/我.txt");
//			ft.uploadFile(input,"aa.txt");
//			ft.uploadFile(input, new String("bb.txt".getBytes("GBK"),"iso-8859-1"));
			
			ft.uploadFile("http://10.1.104.27:8080/pdfdocument/docs/bireport/D/D/FZ00_FZ21_9341_D_D_20140716.pdf", "aa.txt");
